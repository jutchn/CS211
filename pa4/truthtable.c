...
strcpy(add->var,var);
    ...
    //     struct gate* second;
    // second = (struct gate*)malloc(sizeof(struct gate));
    // second->params = (int*)malloc(sizeof(int));
    // second->size = 0;
    // second->next = NULL;
    // second->kind = -1;
    // second->params[0] = -1; 
    // struct gate* gay = first;
    // struct gate* pizza = second;

    // while(gay!=NULL){
    //     while(pizza->next!=NULL){
    ...
    //     if(gay->kind==6){
    //         for(int i = 0; i<gay->size+power(gay->size);i++){
    //             int total = 0;

    //             total = total + values[gay->params[i]].hit;
    //             if(total==0){
    //                 pizza->next = gay;
    //             } else{
    //                 for(int i = 0; i<gay->size;i++){
    //                     values[gay->params[i]].hit = 0;
    //                 }
    //             }
    //         }

    //     } else if(gay->kind==7){
    //         for(int i = 0; i<gay->size+power(gay->size)+1;i++){
    //             int total = 0;
